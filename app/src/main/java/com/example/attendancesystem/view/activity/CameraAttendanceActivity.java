...
public class CameraAttendanceActivity extends AppCompatActivity {
    public static final int CAMERA_PERM_CODE = 101;
    public static final int CAMERA_REQUEST_CODE = 1;
    public static final int GALLERY_REQUEST_CODE = 105;
    private static final int MAX_ALLOWED_BYTE_COUNT = 2*1080*1080;
        ...
        if(reqCode == CAMERA_REQUEST_CODE){
            if (resCode == RESULT_OK) {
                ...
                try {
                    ...
                    selectedImagePath = getPath(getApplicationContext(), Uri.fromFile(f));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
//            img_from_gallery.setImageURI(Uri.fromFile(f));
